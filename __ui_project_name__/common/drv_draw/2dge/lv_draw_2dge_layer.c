...
void lv_draw_2dge_layer(lv_draw_unit_t *draw_unit, const lv_draw_image_dsc_t *draw_dsc,
                        const lv_area_t *coords)
{
    ...
    lv_draw_2dge_image(draw_unit, &new_draw_dsc, coords);
